...
public class FIPCase extends FIPBase {
    ...
    @Test
    public void FIP_buySuccessNoAcceptService(){
    ...
    @Test
    public void FIP_buyLowerThanMin(){
    ...
    @Test
    public void FIP_buyMoreThanMax(){
    ...
    @Test
    public void FIP_MyFIPAccountOut(){
    ...
    @Test
    public void FIP_MyFIPAccountIn(){
    ...
    @Test
    public void FIP_MyFIPAccountDealList(){
    ...
    @Test
    public void FIP_MyFIPOrderDetail(){
    ...
    @Test
    public void FIP_MyFIPHistoryOrderList(){

...
//            mainObj = Other.unlock(solo,User.User_FIP,User.Psw_Login_FIP);
    ...
    @Test
    public void RYB_BuyMoreThanHave(){
    ...
    @Test
    public void RYB_ReedemVirtualAccounts(){
    ...
    @Test
    public void RYB_ReedemBindCard(){
    ...
    @Test
    public void Fund_BuyMoreThanHave(){
    ...
    @Test
    public void Fund_ReedemAccountsRealTime(){
    ...
    @Test
    public void Fund_ReedemAccountsNomal(){
